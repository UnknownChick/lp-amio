## Introduction
Le choix d'un microcontrôleur n'est pas facile parmi une centaine de modèles existants. Idéalement, un projet comprend un cahier des charges. Ce cahier des charges permet de définir les besoins au niveau matériel (nombres d'entrée-sortie, vitesse de traitement, modes de connexion, besoin en mémoire, ...). Il oriente donc vers le choix de tel ou tel type de microcontrôleur. Dans la réalité, il faut bien sûr un cahier des charges, mais prendre en compte aussi un certain nombre de contraintes externes : 
