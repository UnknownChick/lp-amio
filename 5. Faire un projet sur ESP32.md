...
* Renommer le fichier Firmware.ino en fichier principal main.cpp car PlatformIO ne reconnaît pas les fichiers Arduino en .ino.
* Téléverser main.cpp.

Et normalement votre projet affiche une erreur et ne fonctionne pas.
